...
export class CategoriasTable1747371233757 implements MigrationInterface {
    name = 'CategoriasTable1747371233757'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "reporte" ("id" SERIAL NOT NULL, "nombre" character varying NOT NULL, "direccion" character varying, "descripcion" character varying NOT NULL, "creado_en" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_8ff73251b8d9b8c8c6acf1deb46" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "categoria" ("id" SERIAL NOT NULL, "fecha" TIMESTAMP, "horaIngreso" TIME, "horaSalida" TIME, "area" text, "marca" character varying(50) NOT NULL, "modelo" character varying(50) NOT NULL, "tipo" character varying(50) NOT NULL, "descripcion" text, "cantidad" numeric(5,2) NOT NULL, "materiales" text, "acciones" character varying(50), CONSTRAINT "PK_f027836b77b84fb4c3a374dc70d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "clientes" ("id" SERIAL NOT NULL, "nombre" character varying NOT NULL, "correo" character varying NOT NULL, "telefono" character varying NOT NULL, "cedula" character varying NOT NULL, "direccion" character varying, "creado_en" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_d76bf3571d906e4e86470482c08" PRIMARY KEY ("id"))`);
